...
class Assignment(Base):
    ...
    units: Mapped[float] = mapped_column(Float, default=1.0)  # 0..2 (200%)
    work_hours: Mapped[float] = mapped_column(Float, default=0.0)  # planned
    actual_work_hours: Mapped[float] = mapped_column(Float, default=0.0)
    cost: Mapped[float] = mapped_column(Float, default=0.0)  # planned
